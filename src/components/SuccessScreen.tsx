    ...
    <>
      ...
      <div className="whatsapp-cta">
        ...
        <div className="whatsapp-cta-text">
          <span className="whatsapp-cta-label">Stay in the loop</span>
          <span className="whatsapp-cta-desc">Join our official WhatsApp channel for updates, early access, and news as we build.</span>
        </div>
        <a
          href="https://whatsapp.com/channel/0029Vb7iszH0G0XYlLpxLr1l"
          target="_blank"
